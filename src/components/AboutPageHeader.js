    ...
    return (
      <section className="aboutPageHeader" ref={el}>
          ...
          <div className="aboutPageHeaderLinks">
            ...
            <a className="mainBtn" href="http://wordpress.paystrup.dk/wp-content/uploads/2022/09/Nikolaj-Friis-Pejstrup-CV2022-1.pdf" target="_blank" rel="noreferrer noopener"> DOWNLOAD MY CV</a>
          </div>
      </section>
    );
}